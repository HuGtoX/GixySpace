...
paths:
  /chat/completions:
    post:
      summary: Chat（Deepseek）
      deprecated: false
      description: |-
        来自知名私募巨头幻方。
        支持模型：
        deepseek-chat（官方版）
        deepseek-reasoner（官方版）
        deepseek-v3-huoshan（火山引擎部署版本，已指向火山引擎最新的0324版本）
        deepseek-r1-huoshan（火山引擎部署版本）
        deepseek-v3-baidu（百度云部署版本）
        deepseek-r1-baidu（百度云部署版本）
        deepseek-r1（多渠道负载均衡版）
        deepseek-v3-aliyun（阿里云部署版本）
        deepseek-r1-aliyun（阿里云部署版本）
        deepseek-r1-302（302部署版本；已更新最新版R1）
        deepseek-v3-302（302部署版本）
        deepseek-v3-0324（Deepseek最新版V3）
        deepseek-r1-0528（302部署版本）
        deepseek-v3.1（官方版）
        deepseek-v3.1-huoshan（火山引擎部署版本）
      ...
      responses:
        "200":
          ...
          x-apifox-name: OK
      security: []
      x-apifox-folder: 语言大模型/国产模型
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/4012774/apis/api-171145944-run
components:
  schemas: {}
  securitySchemes:
    apiKeyAuth:
...
export interface ApifoxModel {
     ...
     * 域名黑名单
     */
    "search-exclude-sites"?: string[];
    /**
     * 域名白名单
     */
    "search-include-sites": string[];
    /**
     * 搜索条数
     */
    "search-results"?: number;
    /**
     * 选择搜索服务，支持search1api tavily exa bocha metaso
     */
